...
df <- read.table("./04 - Output/iSNV_data/sample_data_with_meta.txt", header = TRUE)
...
if (save) {
  ggsave(
    plot = fig1,
    filename = "./05 - Figures and Tables/Rendered/tif/fig1.tif",
    width = 13,
    height = 8
  )
  ...
  ggsave(
    plot = fig1,
    filename = "./05 - Figures and Tables/Rendered/eps/fig1.eps",
    width = 13,
    height = 8
  )
  ggsave(
    plot = fig1,
    filename = "./05 - Figures and Tables/Rendered/png/fig1.png",
    width = 13,
    height = 8
  )
}
